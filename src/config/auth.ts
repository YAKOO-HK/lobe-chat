...
declare global {
  ...
  namespace NodeJS {
    interface ProcessEnv {
      ...
      GOOGLE_EMAIL_DOMAIN_ALLOWED?: string;
...
export const getAuthConfig = () => {
  ...
  return createEnv({
    ...
    server: {
      ...
      GOOGLE_EMAIL_DOMAIN_ALLOWED: z.string().optional().default(''),
    ...
    runtimeEnv: {
      ...
      GOOGLE_EMAIL_DOMAIN_ALLOWED: process.env.GOOGLE_EMAIL_DOMAIN_ALLOWED,
